...
public class AppController extends BaseController {
	...
	public String app(ModelMap map, HttpServletRequest request) {
		...
		log.info(String.format("Received GET request at endpoint: /app/ for model: %s. Container path: %s", getAppTitle(appRequestInfo), buildContainerPath(request, appRequestInfo)));
